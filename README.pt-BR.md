...
navegador; para fixar um, use **Configurações → Geral → Idioma da interface**. A escolha é
guardada no servidor, então vale para qualquer navegador que abrir a aplicação.
